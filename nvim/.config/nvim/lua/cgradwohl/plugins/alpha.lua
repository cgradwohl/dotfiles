return {
    ...
    config = function()
        ...
        vim.api.nvim_set_hl(0, "AlphaHeader", { fg = "#00FF00" })
...
--       dashboard.section.header.val = {
--         [[__ __    ___  _      _       ___          __  ____     ___   ____  ______  __ __  ____     ___                  ]],
--         [[|  T  T  /  _]| T    | T     /   \        /  ]|    \   /  _] /    T|      T|  T  T|    \   /  _]                ]],
--         [[|  l  | /  [_ | |    | |    Y     Y      /  / |  D  ) /  [_ Y  o  ||      ||  |  ||  D  ) /  [_                 ]],
--         [[|  _  |Y    _]| l___ | l___ |  O  |     /  /  |    / Y    _]|     |l_j  l_j|  |  ||    / Y    _]                ]],
--         [[|  |  ||   [_ |     T|     T|     |    /   \_ |    \ |   [_ |  _  |  |  |  |  :  ||    \ |   [_      __  __  __ ]],
--         [[|  |  ||     T|     ||     |l     !    \     ||  .  Y|     T|  |  |  |  |  l     ||  .  Y|     T    |  T|  T|  T]],
--         [[l__j__jl_____jl_____jl_____j \___/      \____jl__j\_jl_____jl__j__j  l__j   \__,_jl__j\_jl_____j    l__jl__jl__j]],
--       }
...
-- 			type = "text",
-- 			val = "hello creature ... what will you create today?",
-- 			opts = { position = "center" },
-- 		}
